export const Moon = () => {
  return (
    <svg
      ...
      height="18"
      fill="currentColor"
      className="bi bi-moon-stars-fill text-white dark:text-white"
      viewBox="0 0 16 16"
    >
...
export const Sun = () => {
  return (
    <svg
      ...
      height="19"
      fill="currentColor"
      className="bi bi-brightness-high-fill text-white dark:text-white"
      viewBox="0 0 16 16"
    >
...
export const UnCheck = () => {
  return (
    <svg
      ...
      height="13"
      fill="currentColor"
      className="bi bi-check-square text-slate-100 dark:text-white"
      viewBox="0 0 16 16"
    >
...
export const Check = () => {
  return (
    <svg
      ...
      height="13"
      fill="currentColor"
      className="bi bi-check-square-fill text-slate-100 dark:text-white"
      viewBox="0 0 16 16"
    >
...
export const Car = () => {
  return (
    <svg
      ...
      height="25"
      fill="currentColor"
      className="bi bi-car-front mt-0.5 text-white dark:text-blue-400"
      viewBox="0 0 16 16"
    >
  ...
  return (
    <>
      <svg
        ...
        className="w-5 h-5 text-white dark:text-white md:text-black"
        aria-hidden="true"
        xmlns="http://www.w3.org/2000/svg"
        fill="none"
        viewBox="0 0 20 20"
...
export const CaretDown = () => {
  return (
    <svg
      ...
      height="16"
      fill="currentColor"
      className="bi bi-caret-down-fill text-white dark:text-white"
      viewBox="0 0 16 16"
    >
...
export const CircleHalf = () => {
  return (
    <svg
      ...
      height="16"
      fill="currentColor"
      className="bi bi-circle-half text-white"
      viewBox="0 0 16 16"
    >
